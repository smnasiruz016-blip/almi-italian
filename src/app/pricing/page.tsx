...
const INCLUDED = [
  ...
  "Every section: Ascolto, Lettura, Analisi, Produzione scritta and orale",
];
...
export default function Page() {
  return (
    <Article
      ...
      lede="$12/month with a 7-day free trial — your card is saved at checkout, not charged. Cancel anytime."
    >
