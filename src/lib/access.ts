...
//   • Objective, auto-marked skills (Reading/Listening/Analysis) → free to any signed-in user.
//   • AI-feedback skills (Writing/Speaking — section kind "estimate") → require hasPaidAccess().
