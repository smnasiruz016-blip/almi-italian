...
eq(CILS_UNO_ITEMS.length, 75, "CILS UNO = 75 items");
eq(CILS_DUE_ITEMS.length, 75, "CILS DUE = 75 items");
eq(CELI_DUE_ITEMS.length, 60, "CELI 2 = 60 items");
eq(BATCH1_ITEMS.length, 270, "Batch 1 total = 270 items");
...
eq(keys.size, 270, "270 distinct dedup keys");
...
// CILS UNO
assert(at("CILS_STANDARD", "UNO", "ASCOLTO") >= 15, "UNO Ascolto >= 15");
assert(at("CILS_STANDARD", "UNO", "LETTURA") >= 15, "UNO Lettura >= 15");
assert(at("CILS_STANDARD", "UNO", "ANALISI") >= 15, "UNO Analisi >= 15");
assert(at("CILS_STANDARD", "UNO", "SCRITTA") >= 15, "UNO Scritta >= 15");
assert(at("CILS_STANDARD", "UNO", "ORALE") >= 15, "UNO Orale >= 15");
// CILS DUE
assert(at("CILS_STANDARD", "DUE", "ASCOLTO") >= 15, "DUE Ascolto >= 15");
assert(at("CILS_STANDARD", "DUE", "LETTURA") >= 15, "DUE Lettura >= 15");
assert(at("CILS_STANDARD", "DUE", "ANALISI") >= 15, "DUE Analisi >= 15");
assert(at("CILS_STANDARD", "DUE", "SCRITTA") >= 15, "DUE Scritta >= 15");
assert(at("CILS_STANDARD", "DUE", "ORALE") >= 15, "DUE Orale >= 15");
// CELI 2
assert(at("CELI", "DUE", "ASCOLTO") >= 15, "CELI Ascolto >= 15");
assert(at("CELI", "DUE", "LETTURA") >= 15, "CELI Lettura >= 15");
assert(at("CELI", "DUE", "SCRITTA") >= 15, "CELI Scritta >= 15");
assert(at("CELI", "DUE", "ORALE") >= 15, "CELI Orale >= 15");
