// CELI 2 (B1) — 60 items. CELI level code = DUE (distinct from CILS DUE=B2 because exam=CELI).
...
export const CELI_DUE_ITEMS: RawItem[] = [
  ...
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "FOUNDATION",
    title: "Messaggio per rimandare un'uscita", topicTag: "vita sociale",
    prompt: "Scrivi il messaggio.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Avevi un appuntamento con un amico sabato ma non puoi più. Scrivi un messaggio: spiega perché, scusati e proponi un'altra data.",
      context: "Registro informale, messaggio breve.",
      minWords: 40, maxWords: 70,
      criteria: ["Motivo chiaro e breve", "Formula di scuse", "Proposta di una nuova data", "Registro informale coerente"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "FOUNDATION",
    title: "Annuncio per vendere una bicicletta", topicTag: "servizi",
    prompt: "Scrivi l'annuncio.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Vuoi vendere la tua bicicletta. Scrivi un annuncio: descrivila, di' da quanto tempo ce l'hai, indica il prezzo e come contattarti.",
      context: "Annuncio breve per una bacheca o un gruppo online.",
      minWords: 40, maxWords: 70,
      criteria: ["Descrizione con almeno tre dettagli", "Indicazione di prezzo e condizioni", "Modalità di contatto", "Testo ordinato e leggibile"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Email per invitare dei colleghi", topicTag: "lavoro",
    prompt: "Scrivi l'email.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Organizzi una cena per salutare una collega che cambia lavoro. Scrivi un'email agli altri colleghi: di' quando e dove, spiega il motivo e chiedi conferma entro una data.",
      context: "Registro cortese, ambiente di lavoro.",
      minWords: 60, maxWords: 100,
      criteria: ["Oggetto e apertura adeguati", "Informazioni pratiche complete", "Motivo dell'invito", "Richiesta di conferma con scadenza"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Recensione di un film o di un libro", topicTag: "cultura",
    prompt: "Scrivi la recensione.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Scrivi una breve recensione di un film o di un libro che hai visto o letto: racconta di che cosa parla senza svelare il finale, di' che cosa ti è piaciuto e a chi lo consiglieresti.",
      context: "Testo per un blog o un gruppo di lettura.",
      minWords: 60, maxWords: 100,
      criteria: ["Presenta l'opera senza svelare il finale", "Esprime un giudizio motivato", "Indica a chi lo consiglia", "Usa vocabolario di opinione vario"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Email a un albergo per informazioni", topicTag: "viaggi",
    prompt: "Scrivi l'email.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Vuoi prenotare un albergo per tre notti. Scrivi un'email: indica le date, chiedi il prezzo, chiedi se la colazione è compresa e se c'è il parcheggio.",
      context: "Registro formale semplice, primo contatto.",
      minWords: 60, maxWords: 100,
      criteria: ["Date e numero di persone indicati", "Almeno tre domande distinte", "Formule di apertura e chiusura formali", "Richiesta di risposta"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Risposta a un invito che non puoi accettare", topicTag: "vita sociale",
    prompt: "Scrivi la risposta.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Un amico ti invita al suo matrimonio, ma quel giorno sei fuori città per lavoro. Rispondi: ringrazia, spiega perché non puoi venire e proponi di vedervi in un altro momento.",
      context: "Registro informale ma attento, occasione importante.",
      minWords: 60, maxWords: 100,
      criteria: ["Ringraziamento sincero", "Motivo dell'assenza", "Proposta alternativa concreta", "Tono adeguato all'occasione"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Email per un corso che non è come previsto", topicTag: "servizi",
    prompt: "Scrivi l'email.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Ti sei iscritto a un corso, ma gli orari sono cambiati e ora non puoi frequentare. Scrivi alla segreteria: spiega la situazione e chiedi se puoi passare a un altro gruppo o riavere la quota.",
      context: "Registro formale, tono fermo ma cortese.",
      minWords: 60, maxWords: 100,
      criteria: ["Espone i fatti in ordine", "Distingue il problema dalla richiesta", "Formula due opzioni possibili", "Resta cortese pur chiedendo qualcosa"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "CORE",
    title: "Descrivere il proprio quartiere a chi arriva", topicTag: "vita sociale",
    prompt: "Scrivi il testo.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Un amico viene ad abitare nel tuo quartiere. Scrivigli un testo: com'è la zona, che cosa c'è di utile vicino, che cosa gli consigli e che cosa secondo te gli darà fastidio.",
      context: "Testo informale e pratico.",
      minWords: 60, maxWords: 100,
      criteria: ["Descrizione con esempi concreti", "Almeno due indicazioni utili", "Un aspetto negativo detto con onestà", "Organizzazione chiara del testo"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "STRETCH",
    title: "Lettera per proporre un'iniziativa", topicTag: "opinione",
    prompt: "Scrivi la lettera.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Nel tuo quartiere manca uno spazio dove i ragazzi possano stare il pomeriggio. Scrivi una lettera per proporre un'iniziativa: descrivi il problema, proponi una soluzione e di' chi potrebbe occuparsene.",
      context: "Lettera pubblica, registro formale.",
      minWords: 80, maxWords: 130,
      criteria: ["Descrive il problema con esempi", "Propone una soluzione realistica", "Indica chi potrebbe realizzarla", "Anticipa un'obiezione possibile", "Struttura in paragrafi"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "STRETCH",
    title: "Racconto: una decisione difficile", topicTag: "vita sociale",
    prompt: "Scrivi il racconto.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Racconta una decisione difficile che hai preso: qual era la situazione, fra che cosa dovevi scegliere, che cosa hai deciso e come è andata.",
      context: "Testo narrativo personale.",
      minWords: 80, maxWords: 130,
      criteria: ["Situazione iniziale chiara", "Le alternative reali fra cui sceglieva", "Uso sicuro dei tempi del passato", "Esito e riflessione finale", "Racconta la propria esperienza, senza trarne regole generali"],
    },
  },
  {
    exam: "CELI", level: L, section: "SCRITTA", taskType: "WRITING", difficulty: "STRETCH",
    title: "Due punti di vista su una notizia", topicTag: "opinione",
    prompt: "Scrivi il testo.", guidanceNote: est(),
    payload: {
      part: "WRITTEN",
      task: "Nella tua città si discute se chiudere una strada del centro alle auto. Scrivi un testo che presenti onestamente le ragioni di chi è favorevole e di chi è contrario, e poi di' che cosa ne pensi tu.",
      context: "Testo di opinione per un giornale locale.",
      minWords: 80, maxWords: 130,
      criteria: ["Presenta entrambe le posizioni con equità", "Non deforma la posizione contraria", "Prende posizione in modo esplicito", "Distingue i fatti dalle proprie opinioni", "Usa connettivi di contrasto e conclusione"],
    },
  },
  ...
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "FOUNDATION",
    title: "Parlare della propria giornata libera", topicTag: "descrizione",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Racconta com'è una tua giornata libera: che cosa fai la mattina, il pomeriggio e la sera, e con chi.",
      parts: ["La mattina", "Il pomeriggio", "La sera e con chi"],
      criteria: ["Sequenza chiara della giornata", "Uso del presente e delle espressioni di tempo", "Frasi collegate fra loro", "Pronuncia comprensibile"],
      prepSeconds: 30, speakSeconds: 90,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "FOUNDATION",
    title: "Descrivere una persona importante per te", topicTag: "descrizione",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Descrivi una persona importante nella tua vita: chi è, com'è di carattere, e racconta un episodio che spiega perché conta per te.",
      parts: ["Chi è e da quanto la conosci", "Com'è di carattere", "Un episodio che la racconta"],
      criteria: ["Aggettivi di carattere appropriati", "Un episodio concreto, non solo aggettivi", "Uso del passato nel racconto", "Discorso fluido e comprensibile"],
      prepSeconds: 30, speakSeconds: 90,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "FOUNDATION",
    title: "Simulazione: al ristorante", topicTag: "viaggi",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Sei al ristorante. Chiedi un tavolo, fai delle domande sul menù, ordina e alla fine chiedi il conto.",
      parts: ["Chiedere il tavolo", "Domande sul menù e ordinazione", "Chiedere il conto"],
      criteria: ["Formule di cortesia adeguate", "Domande pertinenti sul menù", "Gestione dello scambio con il cameriere", "Chiusura corretta dello scambio"],
      prepSeconds: 30, speakSeconds: 90,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "CORE",
    title: "Raccontare un viaggio", topicTag: "viaggi",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Racconta un viaggio che hai fatto: dove sei andato, che cosa hai visto, che cosa è andato bene e che cosa no.",
      parts: ["Dove e con chi", "Che cosa hai fatto", "Che cosa non è andato come speravi"],
      criteria: ["Racconto ordinato nel tempo", "Uso di passato prossimo e imperfetto", "Almeno un dettaglio memorabile", "Valutazione finale motivata"],
      prepSeconds: 45, speakSeconds: 120,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "CORE",
    title: "Simulazione: cambiare un acquisto", topicTag: "servizi",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Hai comprato una giacca e vuoi cambiarla: la taglia è sbagliata. Spiega la situazione al negozio, di' che cosa vuoi e reagisci se ti dicono che non è possibile.",
      parts: ["Spiegare il problema", "Dire che cosa chiedi", "Reagire a una risposta negativa"],
      criteria: ["Esposizione chiara del problema", "Richiesta esplicita", "Gestione della risposta negativa senza scortesia", "Proposta di una soluzione alternativa"],
      prepSeconds: 45, speakSeconds: 120,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "CORE",
    title: "Confrontare due modi di passare il tempo libero", topicTag: "opinione",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Confronta due modi di passare il tempo libero — per esempio stare in casa e uscire, oppure sport e lettura. Di' vantaggi e svantaggi di ciascuno e che cosa preferisci tu.",
      parts: ["Il primo modo: vantaggi e svantaggi", "Il secondo modo: vantaggi e svantaggi", "La tua preferenza e perché"],
      criteria: ["Strutture di confronto (più… di, mentre)", "Almeno un vantaggio e uno svantaggio per parte", "Preferenza motivata", "Discorso organizzato"],
      prepSeconds: 45, speakSeconds: 120,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "CORE",
    title: "Descrivere una foto di una piazza", topicTag: "descrizione",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Guarda la foto di una piazza affollata in una giornata di sole. Descrivi che cosa vedi, immagina che cosa stanno facendo le persone e di' se ti piacerebbe essere lì.",
      parts: ["Che cosa vedi", "Che cosa stanno facendo le persone", "Ti piacerebbe essere lì? Perché"],
      criteria: ["Descrizione ordinata (primo piano, sfondo)", "Uso di 'stare + gerundio' per le azioni", "Distinzione fra ciò che si vede e ciò che si immagina", "Opinione finale motivata"],
      prepSeconds: 45, speakSeconds: 120,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "CORE",
    title: "Simulazione: chiedere informazioni per un corso", topicTag: "servizi",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Telefoni a una scuola per informazioni su un corso. Chiedi orari, prezzo e come ci si iscrive, e spiega il tuo livello.",
      parts: ["Presentarti e dire che cosa cerchi", "Le domande pratiche", "Spiegare il tuo livello e concordare i passi successivi"],
      criteria: ["Formule del parlato al telefono", "Domande complete e distinte", "Descrizione realistica del proprio livello", "Chiusura con un accordo concreto"],
      prepSeconds: 45, speakSeconds: 120,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "STRETCH",
    title: "Difendere una scelta poco comune", topicTag: "opinione",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Racconta una scelta tua che la maggior parte delle persone intorno a te non ha capito. Spiega le tue ragioni, di' che cosa ti è costata e rispondi all'obiezione più comune.",
      parts: ["Qual è stata la scelta", "Le tue ragioni", "L'obiezione più comune e la tua risposta"],
      criteria: ["Ragioni esposte in ordine di importanza", "Riconosce il costo della scelta", "Risponde all'obiezione senza irritarsi", "Registro controllato e argomentazione collegata"],
      prepSeconds: 60, speakSeconds: 150,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "STRETCH",
    title: "Spiegare un'abitudine del proprio paese", topicTag: "cultura",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Spiega un'abitudine del posto da cui vieni che qui sorprende le persone: che cos'è, quando si fa e perché secondo te esiste. Poi di' che cosa ne pensi tu.",
      parts: ["Che cos'è e quando si fa", "Perché secondo te esiste", "Che cosa ne pensi tu"],
      criteria: ["Descrizione concreta con un esempio", "Spiegazione presentata come propria interpretazione", "Opinione personale distinta dalla descrizione", "Parla della propria esperienza, senza generalizzare su interi popoli"],
      prepSeconds: 60, speakSeconds: 150,
    },
  },
  {
    exam: "CELI", level: L, section: "ORALE", taskType: "SPEAKING", difficulty: "STRETCH",
    title: "Mettersi d'accordo su un regalo", topicTag: "vita sociale",
    prompt: "Parla seguendo i punti.", guidanceNote: est(),
    payload: {
      part: "ORAL",
      task: "Devi scegliere un regalo insieme a un'altra persona che ha un'idea diversa dalla tua. Proponi la tua idea, ascolta l'obiezione e trova un accordo.",
      parts: ["La tua proposta e perché", "L'obiezione dell'altra persona", "L'accordo finale"],
      criteria: ["Proposta motivata", "Riformula l'obiezione prima di rispondere", "Cede su qualcosa senza rinunciare a tutto", "Chiude con un accordo esplicito"],
      prepSeconds: 60, speakSeconds: 150,
    },
  },
];
