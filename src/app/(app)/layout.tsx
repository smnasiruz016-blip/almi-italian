...
// attempt pages, guides, study-in-italy, …) stays under the root layout so it
// keeps rendering to anonymous visitors and stays statically generated.
...
export default async function AppLayout({
  ...
  return (
    <div className="bg-almi-bg">
      ...
      <Sidebar email={user.email} isAdmin={isAdmin(user.email)} logout={logoutAction} />
